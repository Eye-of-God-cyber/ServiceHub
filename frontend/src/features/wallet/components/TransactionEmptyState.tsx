...
export function TransactionEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center border border-dashed rounded-3xl bg-muted/10">
      ...
      <h3 className="text-2xl font-bold mb-3">No Wallet Activity Yet</h3>
      <p className="text-muted-foreground mb-8 max-w-md mx-auto text-lg leading-relaxed">
        Your wallet is currently empty. Book a service and enjoy seamless payments through your ServiceHub wallet!
      </p>
